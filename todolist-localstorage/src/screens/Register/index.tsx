...
const Register: React.FC<IRegisterProps> = ({ onSubmit }) => {
    ...
    return (
        <>
            <Title>Cadastre-se & Acesse</Title>
            <RegisterForm onSubmit={handleSubmit}>
                ...
                <InputRegister type='email' name='email' value={formData.email} onChange={handleChange} placeholder='Informe seu e-mail' />
                <LabelRegister>Idade:</LabelRegister>
                <InputRegister type='text'name='age' value={formData.age} onChange={handleChange} placeholder='Informe sua idade' />
